...
import { Divider, getRandomColor, styles } from "./components"

const EventPackage = styled(Grid)`
	background-color: ${props => props.theme.grey[100]};
	border: 2px solid ${props => props.selected ? props.theme.primary.light : "transparent"};
	border-radius: 4px;
`
  ...
  return (
    <div>
    	<Card className={classes.card} style={{borderColor: getRandomColor()}}>
	    	<Typography variant="h6" className={classes.cardName}>Your Information</Typography>
	    	...
	    	<Grid container spacing={8} style={{marginBottom:"20px"}}>
  			...
  			<Grid container spacing={24}>
  				<Grid item xs={12} md={6}>
		  	    	...
		  	    	<Grid item xs>
		  	    		<Typography variant="subtitle2"className={classes.lineHeight} >Bowler Hall</Typography>
		  	    		<Typography variant="body2">Blah blah blah something about Bowler hall...</Typography>
		  	    	</Grid>
		  	    	<Grid item>
		  	    		<Typography variant="subtitle1" color="primary">$19.00</Typography>
		  	    	</Grid>
  					</EventPackage>
  				</Grid>
  				...
  				<Grid item xs={12} md={6}>
		  	    	...
		  	    	<Grid item>
		  	    		<Typography variant="subtitle1" className={classes.lineHeight} color="primary">$19.00</Typography>
		  	    	</Grid>
  					</EventPackage>
  				</Grid>
  			</Grid>
